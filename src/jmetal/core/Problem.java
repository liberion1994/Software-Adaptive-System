...
public abstract class Problem implements Serializable {
  ...
  /**
   *  Stores the lower bound values for each variable (only be used in Software Adaptation System)
   */
  protected int [] lowerLimitSAS_ ;
  ...
  /**
   * Stores the upper bound values for each variable (only be used in Software Adaptation System)
   */
