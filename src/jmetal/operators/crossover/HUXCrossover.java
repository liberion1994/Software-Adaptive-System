 ...
 * solutions, and the type of the solutions must be Binary or BinaryReal
 */
public class HUXCrossover extends Crossover {
	 ...
	 */
	private static List VALID_TYPES = Arrays.asList(BinarySolutionType.class, BinaryRealSolutionType.class);
	...
	public Object execute(Object object) throws JMException {
		...
		if (!(VALID_TYPES.contains(parents[0].getType().getClass())
			...
			Configuration.logger_.severe("HUXCrossover.execute: the solutions "
					+ "are not of the right type. The type should be 'Binary' of " + "'BinaryReal', but "
